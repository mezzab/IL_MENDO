...
CREATE TABLE BD.CIUDADES(
	CIUD_ID INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	CIUD_DETALLE VARCHAR(64)
	)
...
CREATE TABLE BD.VIAJES(
	...
	VIAJ_CARGA_ID INT NOT NULL FOREIGN KEY REFERENCES BD.CIUDADES(CIUD_ID),
	VIAJ_DESCARGA_ID INT NOT NULL FOREIGN KEY REFERENCES BD.CIUDADES(CIUD_ID),
